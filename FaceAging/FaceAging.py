...
class FaceAging(object):
    def __init__(self,
                 ...
                 dataset_name='faces'  # name of the dataset in the folder ./data
                 ):
        ...
        for i in range(len(file_names)):
            ...
            if len(dets) is 1:
                for k, d in enumerate(dets):
                    shape = sp(img, d)
                    dlib.save_face_chip(img, shape, "test/result/thumbnail", size=256, padding=0.1)
                ...
                try:
                    ...
                    cv2.imwrite('test/result/' + str(age) + '_' + str(gender) + '_' + file_name.split('\\')[1], output)
                    ...
                    print('\n\tDone! Results are saved as %s' % 'test/result/' + str(age) + '_' + str(gender) + '_' + file_name.split('\\')[1])
                except IndexError as e:
                    print('Result The face is not normal. Please put good quality pictures in your input.')
